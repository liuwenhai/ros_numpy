...
if __name__ == "__main__":
    ...
    rospy.Subscriber('/l515/depth',Image,partial(depth_callback,depth_list=depth_list),queue_size=1)
    rospy.Subscriber('/l515/rgb',Image,partial(rgb_callback,rgb_list=rgb_list),queue_size=1)
